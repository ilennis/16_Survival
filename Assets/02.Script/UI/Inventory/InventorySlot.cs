...
public class InventorySlot : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IDropHandler,IPointerEnterHandler,IPointerClickHandler,IPointerExitHandler, IPointerMoveHandler
{
    ...
    private void Start()
    {
        ...
        slotDragAndDrop = GameManager.Instance.Inventory.SlotDragAndDrop;
    }
    ...
    //아이템 클릭시 호출되는 이벤트
    public void OnPointerClick(PointerEventData eventData) => uiUseItem.OnClickEvent?.Invoke(ItemData, eventData);
